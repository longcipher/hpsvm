...
use solana_transaction::{CompiledInstruction, Transaction, sanitized::MAX_TX_ACCOUNT_LOCKS};
...
fn test_account_loaded_twice() {
    ...
    let data =
        solana_system_interface::instruction::transfer(&payer_pk, &Address::new_unique(), 500_000)
            .data;
