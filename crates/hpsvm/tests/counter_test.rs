...
fn test_register_tracing_handler() {
    ...
    let mut svm = HPSVM::new_debuggable(enable_register_tracing);
    ...
    // HPSVM with enable_register_tracing=false.
    {
        ...
        // Create a new HPSVM instance with register tracing disabled.
        let mut svm_no_tracing = HPSVM::new_debuggable(/* enable_register_tracing */ false);
    ...
    // HPSVM.
    {
        // Create a new HPSVM instance with register tracing enabled.
        let mut svm_with_tracing = HPSVM::new_debuggable(/* enable_register_tracing */ true);
